import { effectScope, reactive, hasInjectionContext, getCurrentInstance, inject, toRef, version, unref, h, shallowRef, shallowReactive, isReadonly, ref, markRaw, toRaw, watch, isRef, isReactive, nextTick, computed, getCurrentScope, onScopeDispose, toRefs, defineComponent, provide, createElementBlock, isShallow, defineAsyncComponent, Suspense, mergeProps, Transition, withCtx, createVNode, useSSRContext, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from "vue";
...
const _routes = [
  {
    ...
    component: () => import("./assets/index-DaNI9o-3.js").then((m) => m.default || m)
  }
];
...
const LazyIcon = defineAsyncComponent(() => import("./assets/Icon-Ccv6vRuM.js").then((r) => r.default));
const LazyIconCSS = defineAsyncComponent(() => import("./assets/IconCSS-CF8v2CLA.js").then((r) => r.default));
...
const layouts = {
  default: () => import("./assets/default-aQgBJlL5.js").then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./assets/error-404-Bi3XLsb5.js").then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import("./assets/error-500-BVRnXyHD.js").then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import("./assets/island-renderer-YXUZjldS.js").then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
